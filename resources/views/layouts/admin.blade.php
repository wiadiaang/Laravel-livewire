...
<html lang="en">
  <head>
    ...
    <link href="{{ asset('assets/dist/css/tabler.min.css?174091842') }}" rel="stylesheet" />
    <!-- END GLOBAL MANDATORY STYLES -->
    <!-- BEGIN PLUGINS STYLES -->
    <link href="{{ asset('assets/dist/css/tabler-flags.min.css?1740918423') }}" rel="stylesheet" />
    <link href="{{ asset('assets/dist/css/tabler-socials.min.css?1740918423') }}" rel="stylesheet" />
    <link href="{{ asset('assets/dist/css/tabler-payments.min.css?1740918423') }}" rel="stylesheet" />
    <link href="{{ asset('assets/dist/css/tabler-vendors.min.css?1740918423') }}" rel="stylesheet" />
    <link href="{{ asset('assets/dist/css/tabler-marketing.min.css?1740918423') }}" rel="stylesheet" />
    <!-- END PLUGINS STYLES -->
    <!-- BEGIN DEMO STYLES -->
    <link href="{{ asset('assets/preview/css/demo.min.css?1740918423') }}" rel="stylesheet" />
    <!-- END DEMO STYLES -->
    <!-- BEGIN CUSTOM FONT -->
    <style>
  ...
  <body>
    ...
    <script src="{{ asset('assets/preview/js/demo-theme.min.js?1740918423') }}"></script>
    ...
    <script src="{{ asset('assets/libs/apexcharts/dist/apexcharts.min.js?1740918423') }}" defer></script>
    <script src="{{ asset('assets/libs/jsvectormap/dist/jsvectormap.min.js?1740918423') }}" defer></script>
    <script src="{{ asset('assets/libs/jsvectormap/dist/maps/world.js?1740918423') }}" defer></script>
    <script src="{{ asset('assets/libs/jsvectormap/dist/maps/world-merc.js?1740918423') }}" defer></script>
    <!-- END PAGE LIBRARIES -->
    <!-- BEGIN GLOBAL MANDATORY SCRIPTS -->
    <script src="{{ asset('assets/dist/js/tabler.min.js?1740918423') }}" defer></script>
    <!-- END GLOBAL MANDATORY SCRIPTS -->
    <!-- BEGIN DEMO SCRIPTS -->
    <script src="{{ asset('assets/preview/js/demo.min.js?1740918423') }}" defer></script>
    <!-- END DEMO SCRIPTS -->
    <!-- BEGIN PAGE SCRIPTS -->
    <script>
