...
<html lang="en">
  <head>
    ...
    <link href="{{ asset('assets/dist/css/tabler.min.css?1740918420') }}" rel="stylesheet" />
    <!-- END GLOBAL MANDATORY STYLES -->
    <!-- BEGIN PLUGINS STYLES -->
    <link href="{{ asset('assets/dist/css/tabler-flags.min.css?1740918420') }}" rel="stylesheet" />
    <link href="{{ asset('assets/dist/css/tabler-socials.min.css?1740918420') }}" rel="stylesheet" />
    <link href="{{ asset('assets/dist/css/tabler-payments.min.css?1740918420') }}" rel="stylesheet" />
    <link href="{{ asset('assets/dist/css/tabler-vendors.min.css?1740918420') }}" rel="stylesheet" />
    <link href="{{ asset('assets/dist/css/tabler-marketing.min.css?1740918420') }}" rel="stylesheet" />
    <!-- END PLUGINS STYLES -->
    <!-- BEGIN DEMO STYLES -->
    <link href="{{ asset('assets/preview/css/demo.min.css?1740918420') }}" rel="stylesheet" />
    <!-- END DEMO STYLES -->
    <!-- BEGIN CUSTOM FONT -->
    <style>
  ...
  <body>
    ...
    <script src="{{ asset('assets/preview/js/demo-theme.min.js?1740918420') }}"></script>
    ...
    <script src="{{ asset('assets/dist/js/tabler.min.js?1740918420') }}" defer></script>
    <!-- END GLOBAL MANDATORY SCRIPTS -->
    <!-- BEGIN DEMO SCRIPTS -->
    <script src="{{ asset('assets/preview/js/demo.min.js?1740918420') }}" defer></script>
    <!-- END DEMO SCRIPTS -->
  </body>
</html>
